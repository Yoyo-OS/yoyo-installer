...
from yoyo_installer.core.timezones import all_timezones, get_current_timezone, get_preview_timezone



@Gtk.Template(resource_path='/org/yoyoos/Installer/gtk/default-timezone.ui')
class YoyoDefaultTimezone(Adw.Bin):
    __gtype_name__ = 'YoyoDefaultTimezone'
