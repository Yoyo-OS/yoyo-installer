...
from yoyo_installer.core.languages import all_languages, current_language


@Gtk.Template(resource_path='/org/yoyoos/Installer/gtk/default-language.ui')
class YoyoDefaultLanguage(Adw.Bin):
    __gtype_name__ = 'YoyoDefaultLanguage'
