...
from yoyo_installer.core.disks import DisksManager, Partition, Diskutils
from yoyo_installer.core.system import Systeminfo


@Gtk.Template(resource_path="/org/yoyoos/Installer/gtk/widget-disk.ui")
class YoyoDefaultDiskEntry(Adw.ActionRow):
    __gtype_name__ = "YoyoDefaultDiskEntry"
...
@Gtk.Template(resource_path="/org/yoyoos/Installer/gtk/widget-partition-row.ui")
...
@Gtk.Template(resource_path="/org/yoyoos/Installer/gtk/widget-partition.ui")
...
@Gtk.Template(resource_path="/org/yoyoos/Installer/gtk/dialog-disk.ui")
class YoyoDefaultDiskPartModal(Adw.Window):
    __gtype_name__ = "YoyoDefaultDiskPartModal"
    __gsignals__ = {
...
@Gtk.Template(resource_path="/org/yoyoos/Installer/gtk/dialog-disk-confirm.ui")
class YoyoDefaultDiskConfirmModal(Adw.Window):
    __gtype_name__ = "YoyoDefaultDiskConfirmModal"
...
@Gtk.Template(resource_path="/org/yoyoos/Installer/gtk/default-disk.ui")
class YoyoDefaultDisk(Adw.Bin):
    __gtype_name__ = "YoyoDefaultDisk"
    ...
    def __init__(self, window, distro_info, key, step, **kwargs):
        ...
        for index, disk in enumerate(self.__disks.all_disks):
            entry = YoyoDefaultDiskEntry(disk, chk_group, use_radio=count_disks > 1)
    ...
    def __on_configure_clicked(self, button):
        ...
        for entry in self.__registry_disks:
            ...
            modal = YoyoDefaultDiskPartModal(self.__window, self, entry.disk)
    ...
    def __on_btn_next_clicked(self, button):
        modal = YoyoDefaultDiskConfirmModal(self.__window, self.__partition_recipe)
        modal.present()
