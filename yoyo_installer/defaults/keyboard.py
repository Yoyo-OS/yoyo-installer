...
from yoyo_installer.core.keymaps import KeyMaps


@Gtk.Template(resource_path='/org/yoyoos/Installer/gtk/default-keyboard.ui')
class YoyoDefaultKeyboard(Adw.Bin):
    __gtype_name__ = 'YoyoDefaultKeyboard'
