...
from yoyo_installer.utils.recipe import RecipeLoader

from yoyo_installer.defaults.welcome import YoyoDefaultWelcome
from yoyo_installer.defaults.language import YoyoDefaultLanguage
from yoyo_installer.defaults.keyboard import YoyoDefaultKeyboard
from yoyo_installer.defaults.timezone import YoyoDefaultTimezone
from yoyo_installer.defaults.users import YoyoDefaultUsers
from yoyo_installer.defaults.disk import YoyoDefaultDisk

from yoyo_installer.layouts.preferences import YoyoLayoutPreferences
from yoyo_installer.layouts.yes_no import YoyoLayoutYesNo
...
templates = {
    "welcome": YoyoDefaultWelcome,
    "language": YoyoDefaultLanguage,
    "keyboard": YoyoDefaultKeyboard,
    "timezone": YoyoDefaultTimezone,
    "preferences": YoyoLayoutPreferences,
    "users": YoyoDefaultUsers,
    "disk": YoyoDefaultDisk,
    "yes-no": YoyoLayoutYesNo
}
