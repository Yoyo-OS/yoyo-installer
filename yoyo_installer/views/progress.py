...
from yoyo_installer.views.tour import YoyoTour


@Gtk.Template(resource_path='/org/yoyoos/Installer/gtk/progress.ui')
class YoyoProgress(Gtk.Box):
    __gtype_name__ = 'YoyoProgress'
    ...
    def __build_ui(self):
        ...
        for _, tour in self.__tour.items():
            self.carousel_tour.append(YoyoTour(self.__window, tour))
