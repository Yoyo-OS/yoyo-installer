...
from yoyo_installer.windows.dialog import YoyoDialog
from gettext import gettext as _

@Gtk.Template(resource_path='/org/yoyoos/Installer/gtk/layout-preferences.ui')
class YoyoLayoutPreferences(Adw.Bin):
    __gtype_name__ = 'YoyoLayoutPreferences'
